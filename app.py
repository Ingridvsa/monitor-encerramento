...
FAVO_TYPES = {
    ...
    "NAO FUNDAMENTADA SEM PECÚNIA", "COM MULTA", "FUNDAMENTADA ATENDIDA SEM PECÚNIA",
    "FUNDAMENTADA ATENDIDA COM PECÚNIA", "FUNDAMENTADA ATENDIDA COM MULTA", "NÃO INTEGRA O POLO PASSIVO",
    "ACORDO DE TERCEIRO", "ACORDO DE TERCEIROS", "ACORDO PÓS-SENTENÇA", "ACORDO PROCON", "ACORDO TERCEIRIZADO", "ARQUIVADO POR INÉRCIA DAS PARTES",
    "FUNDAMENTADA NÃO ATENDIDA", "RESPOSTA AO OFICIO PROTOCOLADA",  
}
DESF_TYPES = {"PROCEDENTE", "PROCEDENTE EM PARTE", "PROCEDENTE EM PARTE COM AFASTAMENTO DE DANO MORAL", "PROCEDENTE SEM PAGAMENTO"}
IGNORE_TYPES = {"DESCONSIDERAÇÃO DE PATROCÍNIO", "DESCONTRATAÇÃO", "CADASTRO DUPLICADO OU EQUIVOCADO", "Patrocínio Recusado"}
